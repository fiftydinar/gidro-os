...
- [Applied workaround for too aggressive power-saving on AMD GPUs](https://gitlab.freedesktop.org/drm/amd/-/issues/1500#note_1854170) (solves stuttering issues on low-mid GPU load)
