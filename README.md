...
`gidro-os-appimages` is an experimental version of Gidro-OS with flatpak-related stuff removed & with `AM` AppImage manager installed, to see if AppImage-only usage can replace flatpaks in the future.
