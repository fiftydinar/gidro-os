...
- [Sleep Through Notifications](https://gitlab.gnome.org/rhendric/sleep-through-notifications) (disabled by default, useful for setups where sudden screen wake is annoying, while retaining notifications functionality)
...
### [DOWNLOAD LINK](https://archive.org/download/gidro-os_01-07-2024/home/runner/work/gidro-os/gidro-os/upload/gidro-os_01-07-2024.iso)
### [TORRENT LINK](https://archive.org/download/gidro-os_01-07-2024/gidro-os_01-07-2024_archive.torrent)<br/>(higher download speed)
### [ISO CHECKSUM](https://archive.org/download/gidro-os_01-07-2024/home/runner/work/gidro-os/gidro-os/upload/gidro-os_01-07-2024.iso-CHECKSUM)<br/>(verify the checksum if ISO is downloaded correctly with apps like [Collision](https://flathub.org/apps/dev.geopjr.Collision))
