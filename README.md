...
My customized image, based on slightly customized [Fedora Silverblue](https://fedoraproject.org/atomic-desktops/silverblue/), which is derived from amazing [Universal Blue](https://universal-blue.org/scope/#main-images) project.  
