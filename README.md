...
### [DOWNLOAD LINK](https://archive.org/download/gidro-os_07-04-2024/__w/_actions/ublue-os/isogenerator/1.0.9/end_iso/gidro-os_07-04-2024.iso)
### [TORRENT LINK](https://archive.org/download/gidro-os_07-04-2024/gidro-os_07-04-2024_archive.torrent)<br/>(higher download speed)
### [ISO CHECKSUM](https://archive.org/download/gidro-os_07-04-2024/__w/_actions/ublue-os/isogenerator/1.0.9/end_iso/gidro-os_07-04-2024-CHECKSUM)<br/>(verify the checksum if ISO is downloaded correctly with apps like [Collision](https://flathub.org/apps/dev.geopjr.Collision))
