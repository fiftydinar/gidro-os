...
- [Disabled most kernel logs](https://forums.whonix.org/t/set-kernel-printk-sysctl-to-prevent-kernel-info-leaks/18490) (for improving boot/shutdown times & for improving security)
