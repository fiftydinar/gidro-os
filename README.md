...
### [ISO CHECKSUM](https://archive.org/download/gidro-os_06-04-2024/__w/_actions/ublue-os/isogenerator/1.0.9/end_iso/gidro-os_06-04-2024-CHECKSUM) (verify the checksum if ISO is downloaded correctly with apps like [Collision](https://flathub.org/apps/dev.geopjr.Collision))
