...
find "${TMP_DIR}" -mindepth 1 -maxdepth 1 \( -type d -o -name '*.json' -o -name '*.js' -o -name '*.css' \) ! -path "*locale*" ! -path "*schemas*" ! -path "*resources*" -exec cp -r {} /usr/share/gnome-shell/extensions/"${UUID}"/ \;
